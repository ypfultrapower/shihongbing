 ...
 * TypeScript中的type关键字:字面意思，用来给一个类型起个新名字。常用于联合类型
 */
...
const LoginItem: React.FC<LoginItemProps> = (props) => {
  ...
  if(type === "ImgCaptcha"){
    const captchaUrl = '/api/getKaptcha'
    return (
      <FormItem shouldUpdate>
        <Row gutter={8}>
          <Col span={14}>
          ...
          <Col span={10}>
            <img src= {captchaUrl} onClick={(e: React.MouseEvent) => {
              e.target['src'] = captchaUrl+'?rdm='+ Math.floor(Math.random() * 100);
            }}/>
          </Col>
        </Row>
      </FormItem>
