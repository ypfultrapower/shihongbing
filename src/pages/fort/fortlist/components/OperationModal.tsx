...
import {FortTableListItem} from '../data';
import {IP_REG} from "../../../../../config/systemConfig";

interface FormModal {
  visible: boolean;
  submitting:boolean;
  currentItem: Partial<FortTableListItem> | undefined;
  onSubmit: (values: FortTableListItem) => void;
  onCancel: () => void;
}
...
const OperationModal: React.FC<FormModal> = (props) => {
  ...
  const handleFinish = (values: { [key: string]: any }) => {
    if (onSubmit) {
      onSubmit(values as FortTableListItem);
    }
  };
